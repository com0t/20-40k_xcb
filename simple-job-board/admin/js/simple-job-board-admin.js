        ...
        $('#settings_addFeature').on("click", function () {
            ...
            if (fieldName != '' && job_feature_value != '') {
                ...
                if(fieldIcon != undefined && fieldIcon != '' ){
                    $('#settings_job_features').append('<li class="sjb-modern-list jobfeature_' + fieldName + '"><strong>' + application_form.form_fields_title + ': </strong><label class="sjb-editable-label">' + field_name_raw + '</label>\n\
            ...
            if (fieldName != '') {
                if (!(fieldType == 'checkbox' || fieldType == 'dropdown' || fieldType == 'radio')) {
                    $('#app_form_fields').append(
                        '<li class="' + fieldName + '"><label class="sjb-editable-label" for="">' + fieldNameRaw + '</label>'
                    ...
                    $('#app_form_fields').append('<li class="' + fieldName + '"><label class="sjb-editable-label" for="">' + fieldNameRaw + '</label>'
                        + '<input type="hidden"  name="jobapp_' + fieldName + '[label]" value="' + fieldNameRaw + '">'
                        + '<select class="jobapp_field_type" name="jobapp_' + fieldName + '[type]">' + fieldTypeHtml + '</select>\n\
        ...
        function sjb_editable_label(label_class){
            ...
            if(label_class !== undefined){
                ...
                textbox.focusout(function () {
                    ...
                    var label = $(this);
                    santized_label = label.val(sanitize_string(label.val()));
                    label.hide();
